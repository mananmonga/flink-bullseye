 ...
 */
@Internal
public final class BarrierGate<T> extends BroadcastProcessFunction<T, LaneReady, T>
        implements CheckpointedFunction {

    private static final long serialVersionUID = 1L;
    private static final Logger LOG = LoggerFactory.getLogger(BarrierGate.class);
